...
class Sale {
  ...
  factory Sale.fromJson(Map<String, dynamic> json) => Sale(
        sales:
            List<SaleItem>.from(json["sales"].map((x) => SaleItem.fromJson(x))),
        topPicks: List<TopPick>.from(
            json["top_picks"].map((x) => TopPick.fromJson(x))),
        topPicksGuest: List<TopPickGuest>.from(
            json["top_picks_guest"].map((x) => TopPickGuest.fromJson(x))),
        leastCountdown: List<LeastCountdown>.from(
            json["least_countdown"].map((x) => LeastCountdown.fromJson(x))),
        availableProducts: List<AvailableProduct>.from(
            json["available_products"]
                .map((x) => AvailableProduct.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "top_picks_guest":
            List<dynamic>.from(topPicksGuest.map((x) => x.toJson())),
        "least_countdown":
            List<dynamic>.from(leastCountdown.map((x) => x.toJson())),
        "available_products":
            List<dynamic>.from(availableProducts.map((x) => x.toJson())),
      };
}
